...
dispatch is needed. In reality, it has been found that, in large systems written
in languages that support multi-methods (Lisp, Clojure, Julia, Cecil, Dylan,
TADS...), [most methods use
single-dispatch](https://openaccess.wgtn.ac.nz/articles/thesis/Multiple_Dispatch_in_Practice/16959112/1).
The real benefit is in the solution to the Expression Problem.
