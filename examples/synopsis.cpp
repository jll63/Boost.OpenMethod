...
BOOST_OPENMETHOD_OVERRIDE(
    meet,
    (virtual_ptr<Dog> dog1, virtual_ptr<Dog> dog2, std::ostream& os)->void) {
    os << "wag tail";
}

BOOST_OPENMETHOD_OVERRIDE(
    meet,
    (virtual_ptr<Dog> dog, virtual_ptr<Cat> cat, std::ostream& os)->void) {
    os << "chase";
}

BOOST_OPENMETHOD_OVERRIDE(
    meet,
    (virtual_ptr<Cat> cat, virtual_ptr<Dog> dog, std::ostream& os)->void) {
    os << "run";
}
