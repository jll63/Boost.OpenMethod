...
price is paid, the `virtual_ptr` can be used multiple times. It is passed to the
overrider, which can further method calls through it. It can be stored in
variables in place of straight pointers.
