...
* `virtual_ptr<std::shared_ptr<T>>`: defined in <boost/openmethod/shared_ptr.hpp>
* `const virtual_ptr<std::shared_ptr<T>>&`: defined in <boost/openmethod/shared_ptr.hpp>
* `std::unique_ptr<T>`: defined in <boost/openmethod/unique_ptr.hpp>
* `virtual_ptr<std::unique_ptr<T>>`: defined in <boost/openmethod/unique_ptr.hpp>
