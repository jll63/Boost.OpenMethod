...
[#method_override]
## Class Template method::override

`boost::openmethod::method::override` - A class that adds an overrider to an
open-method.
...
|_Functions_
| Functions to add as overriders of method.

|===

`override` must be instantiated as a *static* object.
