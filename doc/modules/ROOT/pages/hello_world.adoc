...
[source,c++]
----
include::example$example/hello_world.cpp[tag=domain_classes]
----
...
[source,c++]
----
include::example$example/hello_world.cpp[tag=method]
----
...
[source,c++]
----
include::example$example/hello_world.cpp[tag=overriders]
----
...
[source,c++]
----
include::example$example/hello_world.cpp[tag=next]
----
...
[source,c++]
----
include::example$example/hello_world.cpp[tag=classes]
----
...
[source,c++]
----
include::example$example/hello_world.cpp[tag=main,indent=0]
----
...
[source,c++]
----
include::example$example/hello_world.cpp[tag=call]
----
